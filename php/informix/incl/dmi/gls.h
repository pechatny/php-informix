...
#if defined (_WIN32) && !defined (_WIN64)
#define GL_VERSION "glslib-6.00.TC10"
#define PLAT_BIT "32"
#elif defined(M64ADDR)
#define GL_VERSION "glslib-6.00.FC10"
#define PLAT_BIT "64"
#elif defined(HPUX_32BIT)
#define GL_VERSION "glslib-6.00.HC10"
#define PLAT_BIT "32"
#else
#define GL_VERSION "glslib-6.00.UC10"
#define PLAT_BIT "32"
#endif

/* Version strings used by DLL version properties box */
#define  GL_VERSION_NUM      6,0,0,10
#if !defined (_WIN64)
#define  GL_VERSION_STR      "6.00.TC10"
#else
#define  GL_VERSION_STR      "6.00.FC10"
#endif

#define GL_NUMVER            6000010   /* Numeric version of 6.00.UC10 */
...
int GL_EXPORT GL_PASCAL _ifx_gl_full_mbdescribe(gl_lc_t lc, gl_wchar_t *wcp, gl_mchar_t *mb, gl_ctype_t *cclass, int mask, int maxbytes);
