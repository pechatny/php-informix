          ...
          char*        argv[] )
{
    ...
    */
    ...
    SQLCHAR         verInfoBuffer[BUFFER_SIZE];
    ...
    SQLCHAR         new_address[BUFFER_SIZE] = "295 Holly Street";
    SQLLEN      new_address_size = SQL_NTS;

    SQLCHAR         new_date[BUFFER_SIZE] = "1995-11-26";
    SQLLEN      new_date_size = SQL_NTS;

    SQLCHAR*		selectStmt = (SQLCHAR *) "SELECT address, contact_dates FROM customer WHERE cust_num = 109";
    SQLCHAR*		updateStmt = (SQLCHAR *) "UPDATE customer SET address = ?, contact_dates = ? WHERE cust_num = 109";
    ...
    */
    ...
    rc = SQLGetInfo (hdbc, SQL_DBMS_VER, verInfoBuffer, BUFFER_SIZE, &verInfoLen);
    ...
    */
    ...
    rc = SQLBindParameter(hstmt, 2, SQL_PARAM_INPUT, SQL_C_CHAR,
                          SQL_CHAR, BUFFER_SIZE, 0, new_address, 0, &new_address_size);
    if (checkError (rc, SQL_HANDLE_STMT, hstmt, (SQLCHAR *) "Error in Step 4 -- SQLBindParameter failed (param 1)\n"))
        goto Exit;
    ...
    */
    ...
    rc = SQLBindParameter(hstmt, 2, SQL_PARAM_INPUT, SQL_C_CHAR,
                          SQL_CHAR, BUFFER_SIZE, 0, new_date, 0, &new_date_size);
    if (checkError (rc, SQL_HANDLE_STMT, hstmt, (SQLCHAR *) "Error in Step 5 -- SQLBindParameter failed (param 1)\n"))
        goto Exit;
